              ...
              itemBuilder: (context, index) {
                return Card(
                  ...
                  child: ListTile(
                    ...
                    title: Text("${docs[index]['name']}",style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),),
                    subtitle: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("Contact-${docs[index]['number']}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                        Text("Section-${docs[index]['section']}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                        Text("Salary-₹${docs[index]['salary']}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                        Text("State-${docs[index]['state']}",style: TextStyle(fontSize: 16,fontWeight: FontWeight.bold),),
                      ],
                    ),
                  ),
                );
